...
export default function ConsultingServicesPage() {
  const t = useTranslations('ConsultingServicesPage');
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 max-w-[1400px] w-full px-6 mx-auto mt-10">
        {serviceIds.map((id, idx) => {
          ...
          return (
            ...
            >
              <Card className="relative h-full rounded-2xl bg-background/80 backdrop-blur border border-border/40 shadow-sm hover:shadow-lg transition-all flex flex-col">
